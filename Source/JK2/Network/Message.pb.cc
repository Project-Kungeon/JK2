...
const ::_pbi::DescriptorTable descriptor_table_Message_2eproto = {
    false, false, 777, descriptor_table_protodef_Message_2eproto,
    "Message.proto",
