...
#include "JK2.h"
#include "Character/PC/JK2PlayerCharacter.h"
...
public:
	...
	TSubclassOf<AJK2PlayerCharacter> OtherPlayerClass;

	TMap<uint64, AJK2PlayerCharacter*> Players;
	AJK2PlayerCharacter* MyPlayer;
};
